...
const ContactFormSection = () => {
  ...
  return (
    <section
      ...
      className={`py-20 px-4 md:px-8 bg-muted/30 transition-all duration-700 ${
    ...
    >
      <div className="max-w-2xl mx-auto">
        ...
        {/* Subtitle */}
        <p className="font-subtitle text-lg md:text-xl text-muted-foreground text-center mb-12">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            <Label htmlFor="nome" className="font-subtitle text-foreground">
              Nome
            </Label>
            <Input
              id="nome"
          ...
          <div className="space-y-2">
            <Label htmlFor="nomeEmpresa" className="font-subtitle text-foreground">
              Nome da Empresa
            </Label>
            <Input
              id="nomeEmpresa"
          ...
          <div className="space-y-2">
            <Label htmlFor="ramoEmpresarial" className="font-subtitle text-foreground">
              Ramo Empresarial
            </Label>
            <Input
              id="ramoEmpresarial"
          ...
          <div className="space-y-2">
            <Label htmlFor="mensagem" className="font-subtitle text-foreground">
              Conte sua dor
            </Label>
            <Textarea
              id="mensagem"
