import { Clock, Zap, Users, DollarSign } from "lucide-react";
...
const stats: StatData[] = [
  { icon: Clock, label: "Atendimento da IA:", value: "24/7" },
  { icon: Zap, label: "Tempo de resposta:", value: "Imediato" },
  { icon: Users, label: "Escalabilidade:", value: "Atende centenas ao mesmo tempo" },
  { icon: DollarSign, label: "Preços:", value: "a partir de R$999,00(pagamento único)" },
];
