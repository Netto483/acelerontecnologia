...
import heroBackground from "@/assets/sites-estrategicos-hero.png?format=webp&quality=80";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <section className="min-h-[320px] py-16 md:py-12 px-6 flex items-center bg-[#F5F4F3] md:bg-[#191518]">
            ...
            <div className="flex flex-col md:flex-row items-start gap-8 md:gap-12">
              ...
              <div className="flex-1 text-left">
                <p className="font-subtitle font-thin text-gray-600 md:text-white/80 text-sm md:text-base leading-relaxed">
                  ...
                  <br /><br />
                  O resultado é um ciclo de vendas mais longo, mais caro e um time comercial sobrecarregado,
        ...
        <section className="py-20 px-6" style={{ backgroundColor: "#F5F4F3" }}>
          <div className="max-w-5xl mx-auto">
            <div className="flex justify-center mb-8">
              <img src={aoIcon} alt="Aceleron Logo" width={64} height={64} className="h-16 w-auto" decoding="async" />
            </div>
